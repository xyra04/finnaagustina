...
try {
    ...
    $mail->Username   = 'finnaagustina19@gmail.com';                     //SMTP username
    $mail->Password   = 'vfxb ssfx erfr ytjg';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS

    //Recipients
    $mail->setFrom('finnaagustina19@gmail.com', 'saran');
    $mail->addAddress('finnaagustina19@gmail.com', 'finnaagustina');     //Add a recipient
